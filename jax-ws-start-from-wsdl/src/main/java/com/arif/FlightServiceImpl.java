 ...
 * @author arif
 */
@WebService(serviceName = "FlightServiceService", portName = "FlightServicePort", endpointInterface = "com.arif.ws.FlightService", targetNamespace = "http://flightservice.arif.com/", wsdlLocation = "wsdl/FlightService.wsdl")
@Stateless
